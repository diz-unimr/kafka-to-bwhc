...
LABEL org.opencontainers.image.created=${BUILD_TIME} \
    ...
    org.opencontainers.image.title="kafka-to-bwhc" \
    org.opencontainers.image.description="Kafka Streams processor to read the mtb file from kafa-topic praediz and send it to bwhc"
